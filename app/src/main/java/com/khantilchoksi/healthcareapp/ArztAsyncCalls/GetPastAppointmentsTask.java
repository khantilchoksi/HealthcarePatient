...
public class GetPastAppointmentsTask extends AsyncTask<Void, Void, Boolean> {

    private static final String LOG_TAG = GetPastAppointmentsTask.class.getSimpleName();
    Context context;
    Activity activity;
    ...
    public GetPastAppointmentsTask(Context context, Activity activity, AsyncResponse asyncResponse, ProgressDialog progressDialog){
    ...
    protected Boolean doInBackground(Void... params) {
        ...
        try {
            ...
            final String CLIENT_BASE_URL = context.getResources().getString(R.string.base_url).concat("getPastAppointmentsOfPatient");
