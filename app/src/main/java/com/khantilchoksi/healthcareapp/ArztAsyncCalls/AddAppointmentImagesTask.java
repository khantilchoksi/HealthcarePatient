...
public class AddAppointmentImagesTask extends AsyncTask<Void, Void, Boolean> {

    private static final String LOG_TAG = AddAppointmentImagesTask.class.getSimpleName();
    Context context;
    Activity activity;
    ...
    public AddAppointmentImagesTask(String appointmentId, AttachmentImagesArrayAdapter attachmentImagesArrayAdapter, Context context, Activity activity, ProgressDialog progressDialog){
    ...
    protected Boolean doInBackground(Void... params) {
        ...
        try {
            ...
            final String CLIENT_BASE_URL = context.getResources().getString(R.string.base_url).concat("addAppointmentAttachments");
    ...
    protected void onPostExecute(Boolean success) {
        ...
        if (success) {
            ...
            Toast.makeText(context,"Attachments Uploaded!",Toast.LENGTH_LONG).show();
