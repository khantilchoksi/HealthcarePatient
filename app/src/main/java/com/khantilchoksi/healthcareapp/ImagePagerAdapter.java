...
public class ImagePagerAdapter extends PagerAdapter {
    ...
    int mSize;
//    int mResources[];
    ImageViewPagerActivityFragment mImageViewPagerActivityFragment;

    public ImagePagerAdapter(Context context, String[] fullImagePaths, int size,
                             ImageViewPagerActivityFragment imageViewPagerActivityFragment){
        mContext = context;
        mLayoutInflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

        this.fullImagePaths = fullImagePaths;
        this.mSize = size;
        this.mImageViewPagerActivityFragment = imageViewPagerActivityFragment;
...
//        mIssueImagesPagerActivityFragment.showProgress(false);
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        String clientIssueImageBasePath = fullImagePaths[position];
